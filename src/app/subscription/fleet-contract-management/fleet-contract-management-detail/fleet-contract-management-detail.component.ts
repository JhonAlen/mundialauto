...
*/
  ...
  //           widths: [60, 150, 70, 60, '*', '*'],
  //           body: [
  //             [{text: 'TOMADOR:', bold: true, border: [true, false, false, false]}, {text: 'hola1', border: [false, false, false, false]}, {text: 'Índole o Profesión:', bold: true, border: [false, false, false, false]}, {text: 'hola2', border: [false, false, false, false]}, {text: 'C.I. / R.I.F.:', bold: true, border: [false, false, false, false]}, {text: 'hola3', border: [false, false, true, false]}]
  //           ]
  //         }
  //       },
  //       {
  ...
  //           widths: [60, 300, 24, '*'],
  //           body: [
  //             [{text: 'DOMICILIO:', bold: true, border: [true, false, false, false]}, {text: 'hola4', border: [false, false, false, false]}, {text: 'Estado:', bold: true, border: [false, false, false, false]}, {text: 'hola5', border: [false, false, true, false]}]
  //           ]
  //         }
  //       },
  //       {
  ...
  //           body: [
  //             [{text: 'Ciudad:', bold: true, border: [true, false, false, true]}, {text: 'hola6', border: [false, false, false, true]}, {text: 'Zona Postal:', bold: true, border: [false, false, false, true]}, {text: 'hola7', border: [false, false, false, true]}, {text: 'Teléfono:', bold: true, border: [false, false, false, true]}, {text: 'hola8', border: [false, false, false, true]}, {text: 'E-mail:', bold: true, border: [false, false, false, true]}, {text: 'hola9', border: [false, false, true, true]}]
  //           ]
  //         }
  //       },
  //       {
  ...
  //           widths: [24, 134, 40, 20, 30, 50, 24, '*'],
  //           body: [
  //             [{text: 'Ciudad:', bold: true, border: [true, false, false, false]}, {text: this.detail_form.get('xciudadpropietario').value, border: [false, false, false, false]}, {text: 'Zona Postal:', bold: true, border: [false, false, false, false]}, {text: 'hola10', border: [false, false, false, false]}, {text: 'Teléfono:', bold: true, border: [false, false, false, false]}, {text: 'hola11', border: [false, false, false, false]}, {text: 'E-mail:', bold: true, border: [false, false, false, false]}, {text: this.detail_form.get('xemailpropietario').value, border: [false, false, true, false]}]
  //           ]
  //         }
  //       },
  //       {
  ...
  //           body: [
  //             [{text: 'INTERMEDIARIO:', bold: true, border: [true, false, false, false]}, {text: this.detail_form.get('xnombrecorredor').value, border: [false, false, false, false]}, {text: 'Control:', bold: true, border: [false, false, false, false]}, {text: this.detail_form.get('ccorredor').value, border: [false, false, false, false]}, {text: 'Participación:', bold: true, border: [false, false, false, false]}, {text: '100%', border: [false, false, true, false]}]
  //           ]
  //         }
  //       },
  //       {
  ...
  //           body: [
  //             [{text: 'N° DE PUESTOS:', bold: true, border: [true, false, false, true]}, {text: this.detail_form.get('ncapacidadpasajerosvehiculo').value, border: [false, false, false, true]}, {text: 'CLASE:', bold: true, border: [false, false, false, true]}, {text: 'hola12', border: [false, false, false, true]}, {text: 'PLACA:', bold: true, border: [false, false, false, true]}, {text: this.detail_form.get('xplaca').value, border: [false, false, false, true]}, {text: 'TRANSMISIÓN:', bold: true, border: [false, false, false, true]}, {text: this.detail_form.get('xtransmision').value, border: [false, false, true, true]}]
  //           ]
  //         }
  //       },
  //       {
  ...
  //           body: [
  //             [{text: 'USO:', bold: true, border: [true, false, false, true]}, {text: 'hola13', border: [false, false, false, true]}, {text: 'SERIAL CARROCERIA:', bold: true, border: [false, false, false, true]}, {text: this.detail_form.get('xserialcarroceria').value, border: [false, false, false, true]}, {text: 'SERIAL DEL MOTOR:', bold: true, border: [false, false, false, true]}, {text: this.detail_form.get('xserialmotor').value, border: [false, false, false, true]}, {text: 'KILOMETRAJE:', bold: true, border: [false, false, false, true]}, {text: 'hola14', border: [false, false, true, true]}]
  //           ]
  //         }
  //       },
  //       {
  ...
  //           body: [
  //             [{text: 'TIPO:', bold: true, border: [true, false, false, false]}, {text: 'hola15', border: [false, false, false, false]}, {text: 'AÑO:', bold: true, border: [false, false, false, false]}, {text: this.detail_form.get('fano').value, border: [false, false, false, false]}, {text: 'COLOR:', bold: true, border: [false, false, false, false]}, {text: this.detail_form.get('xcolor').value, border: [false, false, false, false]}, {text: ' ', border: [false, false, true, false]}]
  //           ]
  //         }
  //       },
  //       {
  ...
  //           widths: [60, 300, '*', '*'],
  //           body: [
  //             [{text: 'TOMADOR:', bold: true, border: [true, false, false, false]}, {text: 'hola17', border: [false, false, false, false]}, {text: 'C.I. / R.I.F.:', bold: true, border: [false, false, false, true]}, {text: 'hola18', border: [false, false, true, true]}]/*,
  ...
  //           widths: [24, 134, 40, 20, 30, 50, 24, '*'],
  //           body: [
  //             [{text: 'Ciudad:', bold: true, border: [true, false, false, false]}, {text: this.detail_form.get('xciudadpropietario').value, border: [false, false, false, false]}, {text: 'Zona Postal:', bold: true, border: [false, false, false, false]}, {text: 'hola19', border: [false, false, false, false]}, {text: 'Teléfono:', bold: true, border: [false, false, false, false]}, {text: this.detail_form.get('xtelefonocliente').value, border: [false, false, false, false]}, {text: 'E-mail:', bold: true, border: [false, false, false, false]}, {text: this.detail_form.get('xemailpropietario').value, border: [false, false, true, false]}]
  //           ]
  //         }
  //       },
  //       {
      ...
      content: [
        ...
        },
        {
          ...
          table: {
            widths: [130, 80, 30, 55, 30, 55, '*'],
            body: [
              [{text: 'Datos del Recibo', alignment: 'center', fillColor: '#ababab', bold: true, border: [true, false, true, true]}, {text: 'Vigencia del Recibo:', bold: true, border: [false, false, false, false]}, {text: 'Desde:', bold: true, border: [false, false, false, false]}, {text: ` `, border: [false, false, false, false]}, {text: 'Hasta:', bold: true, border: [false, false, false, false]}, {text: ` `, border: [false, false, false, false]}, {text: 'Ambas a las 12 AM.', border: [false, false, true, false]}]
            ]
          }
        },
        {
