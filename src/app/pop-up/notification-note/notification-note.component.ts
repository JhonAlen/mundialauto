          ...
          columns: [
            {
              ...
              alignment: 'justify',
              text: [
                {text: 'Yo, '}, {text: `${this.popup_form.get('xnombre').value} `, bold: true}, {text: 'portador de la cedula de identidad No. '}, {text: `${this.popup_form.get('xdocidentidad').value}`, bold: true}, {text: '  '}, {text: 'he recibido de ARYSAUTO la cantidad de '}, {text: `${this.popup_form.get('mtotal').value} `, bold: true}, {text: `${this.popup_form.get('xmoneda').value} `, bold: true},
          ...
          columns: [
            {
              ...
              alignment: 'justify',
              text: [
                {text: 'En virtud de este pago declaro: que no tengo nada más que reclamar a ARYSAUTO por el referido concepto quedando la misma libre de responsabilidad con respecto a todas las consecuencias del mencionado siniestro. Firmo el presente en la ciudad de ___________ a los ___ días del mes de _____de ______'}
              ]
            }
          ]
        },
