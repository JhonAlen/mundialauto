...
export class NotificationNoteComponent implements OnInit {
  ...
  generatePdf(){
            ...
            columns: [
              {
                ...
                alignment: 'justify',
                text: [
                  {text: 'Yo, '}, {text: `${this.popup_form.get('xnombres').value} `, bold: true}, {text: 'portador de la cedula de identidad No. '}, {text: `${this.popup_form.get('xdocidentidad').value}`, bold: true}, {text: '  '}, {text: 'he recibido de La Mundial de Seguros la cantidad de '}, {text: `${this.popup_form.get('mtotalcotizacion').value} `, bold: true}, {text: `${this.popup_form.get('xmoneda').value} `, bold: true},
    ...
    }else if(this.popup_form.get('mmontototalgrua').value){
      const pdfDefinition: any = {
        content: [
          {
            columns: [
          ...
          },
          {
            alignment: 'center',
            text: [
              {text: 'FINIQUITO DE ORDEN DE SERVICIO POR ', bold: true}, {text: 'GRÚA', bold: true}
            ]
          },
          {
            columns: [
            ...
            columns: [
              {
                ...
                alignment: 'justify',
                text: [
                  {text: 'Yo, '}, {text: `${this.popup_form.get('xnombres').value} `, bold: true}, {text: 'portador de la cedula de identidad No. '}, {text: `${this.popup_form.get('xdocidentidad').value}`, bold: true}, {text: '  '}, {text: 'he recibido de Mundial Autos la cantidad de '}, {text: `${this.popup_form.get('mmontototalgrua').value} `, bold: true}, {text: `${this.popup_form.get('xmoneda').value} `, bold: true},
                  {text: 'concepto de Finiquito del '}, {text: 'servicio de grúas', bold: true}, {text: 'con la dirección del inicio '}, {text: `${this.popup_form.get('xdesde').value} `, bold: true}, {text: 'Hasta su finalización '}, {text: `${this.popup_form.get('xhasta').value} `,  bold: true}, {text: 'definitiva, del vehículo descrito en este documento amparado bajo el certificado de afiliación #'}, {text: `${this.popup_form.get('ccontratoflota').value} `, bold: true}, {text: 'a consecuencia del siniestro #'}, {text: `${this.popup_form.get('cnotificacion').value} `,  bold: true}, {text: 'ocurrido el día '},
                  {text: `${this.popup_form.get('fcreacionnotificacion').value}. `, bold: true}
                ]
              }
            ]
            ...
            columns: [
              {
                ...
                alignment: 'justify',
                text: [
                  {text: 'Yo, '}, {text: `${this.popup_form.get('xnombres').value} `, bold: true}, {text: 'portador de la cedula de identidad No. '}, {text: `${this.popup_form.get('xdocidentidad').value}`, bold: true}, {text: '  '}, {text: 'por medio de la presente declaro no realizar ningún reclamo a futuro a esta compañía La Mundial de Seguros, por el '},
                  {text: 'concepto de Finiquito, '}, {text: `${this.popup_form.get('xdanos').value} `, bold: true}, {text: 'definitiva, del vehículo descrito en este documento amparado bajo el certificado de afiliación #'}, {text: `${this.popup_form.get('ccontratoflota').value} `, bold: true}, {text: 'a consecuencia del siniestro #'}, {text: `${this.popup_form.get('cnotificacion').value} `,  bold: true}, {text: 'ocurrido el día '},
                  {text: `${this.popup_form.get('fcreacionnotificacion').value}. `, bold: true}
                ]
              }
            ]
