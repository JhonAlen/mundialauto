...
export class NotificationQuoteComponent implements OnInit {
  ...
  addServiceOrder(){
    if(this.quote){
      let quote = {ccotizacion: this.quote, cnotificacion: this.quote.cnotificacion, cproveedor: this.quote.cproveedor, xnombre: this.quote.xnombre, repuestos: this.quote.replacements, createServiceOrder: true};
